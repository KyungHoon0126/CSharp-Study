...
namespace CSharp_Object_Baisc_Method_Expansion
{
    class Book
    {
        decimal isbn13;
    ...
    class Object_Method_Expansion
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("book2 : " + book2.GetHashCode() + " " + "book3 : " + book3.GetHashCode());
            Console.WriteLine("book2 == book3 : " + book2.GetHashCode().Equals(book3));
        }
    }
}
